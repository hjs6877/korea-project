 ...
 */
public class SqlGroupByMapReduceTest {
    MapDriver<LongWritable, Text, LongWritable, LineItem> mapDriver1;
    ReduceDriver<LongWritable, LineItem, Text, Text> reduceDriver1;
    MapReduceDriver<LongWritable, Text, LongWritable, LineItem, Text, Text> mapReduceDriver1;

    @Before
    public void setUp(){
        SqlGroupByMapper mapper = new SqlGroupByMapper();
        SqlGroupByReducer reducer = new SqlGroupByReducer();
    ...
    public void firstMapTest() throws IOException {
        ...
        mapDriver1.withOutput(new LongWritable(1), item);
        mapDriver1.runTest();
    }
...
//        values.add(new LineItem());
        ...
        reduceDriver1.withInput(new LongWritable(1), Arrays.asList(item1, item2));
    ...
    public void firstMapReduceTest() throws IOException {
        mapReduceDriver1.withInput(new LongWritable(),
                ...
                .withInput(new LongWritable(),
                        new Text("2|6731|732|2|36|58958.28|0.09|0.06|N|O|1996-04-12|1996-02-28|1996-04-20|TAKE BACK RETURN|MAIL|ly final dependencies: slyly bold |"))
                .withInput(new LongWritable(),
                        new Text("11|430|181|1|45|59869.35|0.06|0.25|R|F|1994-02-02|1994-01-04|1994-02-23|NONE|AIR|ongside of the furiously brave acco|"))
                .withInput(new LongWritable(),
        ...
        mapReduceDriver1.withOutput(new Text("row:1\t"), new Text("1\t\t\t1\t\t\t17.0\t0.04\t0.02"))
                        .withOutput(new Text("row:2\t"), new Text("2\t\t\t2\t\t\t36.0\t0.09\t0.06"))
                        .withOutput(new Text("row:3\t"), new Text("3\t\t\t2\t\t\t49.0\t0.11\t0.29"))
                        .withOutput(new Text("row:4\t"), new Text("11\t\t\t1\t\t\t45.0\t0.06\t0.25"));
